...
export const applyAnimation = (
    ...
    // SEAMLESS LOOPING MECHANICS:
    // Progress range is [0, 1) - it approaches 1.0 but never reaches it exactly.
    // At progress ≈ 0.9999, t ≈ 2π, and sin(2π) = sin(0) = 0 (periodic function!)
    // This ensures the last frame is visually identical to the first frame for perfect loops.
    // Integer frequency multiples in animations guarantee exact period alignment.
