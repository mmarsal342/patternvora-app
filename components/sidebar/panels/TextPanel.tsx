                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        onChange={(e) => {
                                            ...
                                            updateText({ maskingMode: val === 'none' ? null : val as 'clip' | 'mosaic' });
                                        }}
                                        className="w-full bg-white border border-indigo-200 rounded-lg p-2 text-xs text-slate-700 appearance-none"
                                    >
                                        <option value="none">Normal (Text on top)</option>
                                        <option value="clip">Clip (Pattern inside text)</option>
                                        <option value="mosaic">Mosaic (Shapes form text)</option>
                                    </select>
                                    <ChevronDown size={12} className="absolute right-2 top-2.5 text-slate-500 pointer-events-none" />
                                </div>
                            </div>

                            {textConfig.maskingMode === 'mosaic' && (
                                <RangeControl
                                    label="Mosaic Density"
                                    value={textConfig.mosaicDensity}
